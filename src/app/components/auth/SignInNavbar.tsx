    ...
    <nav>
      ...
      {navbar && (
        <div className="lg:hidden w-full bg-[#121212] h-screen fixed top-16 left-0 z-50 pt-20">
          ...
          <div onClick={() => router.push("https://www.nobox.cloud/contact-us")} className="bg-[#FFFFFF] text-[#2371D4] w-10/12 md:w-1/2 text-center items-center m-auto py-3 h-12 rounded-lg text-base font-medium cursor-pointer mt-10">
            Contact us
          </div>
        </div>
      )}
