...
export default function Box({
  ...
  return (
    <Link href={link || ""}>
      <div
        key={id}
        className="w-full relative md:w-[224px] h-[193px] bg-white rounded-[2px] p-[16px] cursor-pointer hover:ring hover:ring-blue-500 hover:ring-opacity-50 hover:ring-offset-4 hover:rounded-lg p-4"
        onClick={handleClick}
      >
        <div>
          <svg
