  ...
  return (
    <div>
      <div className="bg-white px-5 py-10">
        <h3 className="text-xl font-bold text-dark">Sign In</h3>
        ...
        >
          <FaArrowLeft className="font-thin" /> Forgot your password?
        </Link>
      ...
      <div className="text-white mt-5 text-center">
        New to NoBox?{" "}
        <Link href={"/signup"} className="pl-2 text-link font-medium">
          Sign Up
        </Link>
      </div>
    </div>
